// TEMPORARY: Test markdown content for demonstration
// This file contains the full AB100 Study Guide for testing the Milkdown editor
export const TEST_MARKDOWN = `# Comprehensive Study Guide for Exam AB-100: Agentic AI Business Solutions Architect
